...
- `web_template.tex` - the main template file should be used for article preparation;
...
- `web_template.bbl` is a sample bibliography file created by BibTeX using the `ios1.bst` file.
