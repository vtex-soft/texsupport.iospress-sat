...
- `sat_template.tex` - the main template file should be used for article preparation;
...
- `sat_template.bbl` is a sample bibliography file created by BibTeX using the `ios1.bst` file.
...
- Use the template file `sat_template.tex` to prepare your manuscript.
